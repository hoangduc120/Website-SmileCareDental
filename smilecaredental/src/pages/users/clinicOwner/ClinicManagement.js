...
//     if (editingClinic) {
//       setClinics(clinics.map(clinic => clinic.id === editingClinic.id ? { ...editingClinic, ...values } : clinic));
//     } else {
//       setClinics([...clinics, { ...values, id: clinics.length + 1 }]);
//     }
//     handleClose();
//   };
...
//     formik.setValues(clinic);// Cập nhật giá trị của formik khi chỉnh sửa
//     handleOpen();
//   };
